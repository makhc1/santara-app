    ...
    <PageWrapper className="!bg-white">
      <div className="h-screen flex flex-col relative px-8 pt-10 pb-8 overflow-y-auto">
        ...
        <div className="space-y-3">
          {/* Phone */}
          <button className="w-full border border-[#E0E0E0] rounded-xl py-3.5 px-5 flex items-center gap-4 hover:bg-gray-50 transition-colors shadow-sm">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <button
            ...
            className="w-full border border-[#E0E0E0] rounded-xl py-3.5 px-5 flex items-center gap-4 hover:bg-gray-50 transition-colors disabled:opacity-50 shadow-sm"
          >
